#!/usr/bin/python
# -*- coding: utf-8 -*-
# estimate_digraphs.py
# Syntax: estimate_digraphs.py <parsed alerts file> <output file>
#     Creates a digraph log file for analysis
#
...
if len(sys.argv) != 3:
    print "Syntax:\testimate_digraphs <parsed alerts file> <output file>"
    sys.exit(2)
else:
    alerts = sys.argv[1]
    output = sys.argv[2]
